...
// Mock product data
const mockProducts = [
    { _id: '654f5a89d70e4c2b918f0a00', name: "গরুর মাংস খিচুড়ি", description: "সুস্বাদু গরুর মাংস এবং মশলা দিয়ে তৈরি মজাদার খিচুড়ি।", price: 250, discount: 10, image: "https://placehold.co/600x400/6B8E23/FFFFFF?text=Beef+Khichuri" },
    { _id: '654f5a89d70e4c2b918f0a01', name: "ডিম খিচুড়ি", description: "ডিম এবং সবজি দিয়ে তৈরি হালকা ও পুষ্টিকর খিচুড়ি।", price: 180, discount: 0, image: "https://placehold.co/600x400/FFD700/6B8E23?text=Egg+Khichuri" },
    { _id: '654f5a89d70e4c2b918f0a02', name: "নিরামিষ খিচুড়ি", description: "বিভিন্ন ধরণের তাজা সবজি দিয়ে তৈরি স্বাস্থ্যকর নিরামিষ খিচুড়ি।", price: 200, discount: 5, image: "https://placehold.co/600x400/FDF9F3/6B8E23?text=Veg+Khichuri" },
    { _id: '654f5a89d70e4c2b918f0a03', name: "মুরগির মাংস খিচুড়ি", description: "দেশি মুরগির মাংসের অসাধারণ স্বাদে ভরপুর এই খিচুড়ি।", price: 220, discount: 0, image: "https://placehold.co/600x400/6B8E23/FFFFFF?text=Chicken+Khichuri" },
    { _id: '654f5a89d70e4c2b918f0a04', name: "ভুনা খিচুড়ি", description: "বিশেষ মশলা এবং কৌশলে তৈরি ভুনা খিচুড়ি।", price: 230, discount: 8, image: "https://placehold.co/600x400/FFD700/6B8E23?text=Bhuna+Khichuri" },
    { _id: '654f5a89d70e4c2b918f0a05', name: "মশলা খিচুড়ি", description: "একদম গরম গরম এবং মশলাদার খিচুড়ি।", price: 190, discount: 0, image: "https://placehold.co/600x400/FDF9F3/6B8E23?text=Spicy+Khichuri" }
];
...
const App = () => {
    ...
    const handleOrderSubmit = async (orderData) => {
        try {
            ...
            console.log('Order Summary:', {
                ...
                itemCount: orderDetails.items.reduce((sum, item) => sum + item.quantity, 0)
            });
            ...
            showCustomMessage(`অর্ডার #${orderNumber} সফলভাবে দেওয়া হয়েছে!`, 'success');
    ...
    const submitReview = async (productId, reviewData) => {
        try {
            ...
            showCustomMessage(error.message || 'রিভিউ সাবমিট করতে সমস্যা হয়েছে', 'error');
            return false;
        }
    };
                ...
                <Routes>
                    ...
                    <Route path="/menu" element={
                     ...
                     <Route path="/product/:id" element={
                         <ProductDetails addToCart={addToCart} products={products} submitReview={submitReview} />
                     } />
